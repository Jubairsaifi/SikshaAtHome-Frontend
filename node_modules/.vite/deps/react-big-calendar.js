...
function useDropdownMenu(options2) {
  ...
  var _options = options2, flip2 = _options.flip, offset3 = _options.offset, rootCloseEvent = _options.rootCloseEvent, _options$fixed = _options.fixed, fixed = _options$fixed === void 0 ? false : _options$fixed, _options$popperConfig = _options.popperConfig, popperConfig = _options$popperConfig === void 0 ? {} : _options$popperConfig, _options$usePopper = _options.usePopper, shouldUsePopper = _options$usePopper === void 0 ? !!context : _options$usePopper;
  var show = (context == null ? void 0 : context.show) == null ? !!options2.show : context.show;
  var alignEnd = (context == null ? void 0 : context.alignEnd) == null ? options2.alignEnd : context.alignEnd;
...
function DropdownMenu(_ref2) {
  var children = _ref2.children, options2 = _objectWithoutPropertiesLoose(_ref2, ["children"]);
  var _useDropdownMenu = useDropdownMenu(options2), props = _useDropdownMenu[0], meta = _useDropdownMenu[1];
...
function addEventListener2(node, eventName, handler, options2) {
  if (options2 && typeof options2 !== "boolean" && !onceSupported2) {
    const {
      once,
      capture
    } = options2;
    ...
    node.addEventListener(eventName, wrappedHandler, optionsSupported2 ? options2 : capture);
  }
  node.addEventListener(eventName, handler, options2);
}
...
function removeEventListener2(node, eventName, handler, options2) {
  const capture = options2 && typeof options2 !== "boolean" ? options2.capture : options2;
  node.removeEventListener(eventName, handler, capture);
  if (handler.__once) {
    node.removeEventListener(eventName, handler.__once, capture);
  }
...
function listen2(node, eventName, handler, options2) {
  addEventListener_default2(node, eventName, handler, options2);
  return () => {
    removeEventListener_default2(node, eventName, handler, options2);
  };
}
...
function getSlotMetrics$1() {
  return memoizeOne(function(options2) {
    var range2 = options2.range, events = options2.events, maxRows = options2.maxRows, minRows = options2.minRows, accessors = options2.accessors, localizer = options2.localizer;
    var _endOfRange = endOfRange({
      dateRange: range2,
      localizer
    }), first = _endOfRange.first, last = _endOfRange.last;
    ...
    return {
      ...
      clone: function clone(args) {
        ...
        return metrics(_objectSpread$4(_objectSpread$4({}, options2), args));
      },
...
WorkWeek.title = function(date2, _ref) {
  ...
  var _workWeekRange = workWeekRange(date2, {
    localizer
  }), _workWeekRange2 = _toArray(_workWeekRange), start2 = _workWeekRange2[0], rest = _arrayLikeToArray(_workWeekRange2).slice(1);
  return localizer.format({
    start: start2,
    end: rest.pop()
  }, "dayRangeHeaderFormat");
